...
class WhitakersLegacyLocalEngine(AlpheiosLegacyXmlEngine):
    """ Whitakers Legacy Local Engine (Whitakers is callable locally)
    """
    ...
    def __init__(self,code, config,**kwargs):
       ...
       :type config: dict
       """
       super(WhitakersLegacyLocalEngine, self).__init__(code, config,**kwargs)
       self.code = code
       self.config = config
